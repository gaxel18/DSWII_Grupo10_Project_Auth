package pe.edu.cibertec.restcontroller;
...
import pe.edu.cibertec.modelo.entities.Comercial;
import pe.edu.cibertec.modelo.entities.Pedido;
import pe.edu.cibertec.modelo.services.IntComercialServices;
import pe.edu.cibertec.modelo.services.IntPedidoServices;
...
public class ComercialController {
	...
	@GetMapping("/")
	public String home() {
		return "index"; // o el nombre de tu vista principal
	}
	@Autowired
